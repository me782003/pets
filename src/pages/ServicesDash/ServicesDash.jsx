...
export default function ServicesDash() {
  ...
  const createService = async () => {
    ...
    try {
      ...
      notify("Servicio creado exitosamente", "success");
      getAllData();
    } catch (error) {
  ...
  const updateService = async () => {
    ...
    try {
      ...
      notify("Servicio actualizado exitosamente", "success");
      getAllData();
    } catch (error) {
      handleErrorResponse(error);
    } finally {
  ...
  const updateStatus = async () => {
    ...
    try {
      ...
      if (res.status === 200) {
        notify("Estado del servicio actualizado exitosamente", "success");
        getAllData();
      }
    } catch (error) {
      handleErrorResponse(error);
